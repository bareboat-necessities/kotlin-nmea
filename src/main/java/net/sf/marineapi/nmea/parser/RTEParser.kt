...
import net.sf.marineapi.nmea.sentence.RTESentenceimport

net.sf.marineapi.nmea.sentence.SentenceIdimport net.sf.marineapi.nmea.sentence.TalkerIdimport net.sf.marineapi.nmea.util.RouteType
/**
 * RTE sentence parser.
 *
