 ...
 * directly. Instead, use [net.sf.marineapi.nmea.parser.SentenceFactory]
 * and [net.sf.marineapi.nmea.io.SentenceReader] classes. This approach is
 * selected to enable registering additional parsers at runtime, by exending the
 * [net.sf.marineapi.nmea.parser.SentenceParser] and registering the new
