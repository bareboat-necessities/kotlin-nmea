...
class UBXMessage00Test {
    ...
    fun testParsinfOfUBXMessage00() {
        ...
        val sentence: Sentence = sf.createParser(message00) as Sentence
        ...
        assertEquals("Wrong FieldCount.", 20, (ubxMessage00 as UBXMessage00Parser).fieldCount)
        assertEquals("Wrong UtcTime.", "202920.000", ubxMessage00.getUtcTime().toString())
        val position: Position = ubxMessage00.getPosition()
